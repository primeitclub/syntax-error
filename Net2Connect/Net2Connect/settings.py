"""
Django settings for Net2Connect project.
...
SECRET_KEY = 'django-insecure-^w^nl^f!ny^^2tdmx6zm#*o8zobn6d3)mt16=1b4yi+!^45di#'
...
WSGI_APPLICATION = 'Net2Connect.wsgi.application'
