...
def project_detail(request, project_id):
    ...
    # Assuming you have related models or methods to get these lists:
    tasks = Task.objects.filter(project=project).values_list('name', flat=True)
    # comments = Comment.objects.filter(project=project)
    # team_members = TeamMember.objects.filter(project=project).values_list('name', flat=True)
